    ...
    public class Bootstrapper
    {
        ...
        public async Task Run()
        {
            ...
            if (!_noConnection)
            {
                ...
                // ★ FIX 2: Turbo Mode auto-reset DIHAPUS — setting ini adalah preferensi
                // persisten milik user, tidak boleh di-reset otomatis oleh sistem.
                // User bisa menonaktifkan Turbo Mode kapan saja lewat UI Settings.
