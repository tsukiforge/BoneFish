...
> [!WARNING]
> **Disclaimer:** This project (BoneFish) is a fork of [Bloxstrap][bloxstrap].
> It is not affiliated with the original Bloxstrap project or Roblox Corporation. Use at your own risk.
...
**BoneFish** (pronounced *bone-fish*) is a powerful custom bootstrapper for Roblox, built on the foundation of [Bloxstrap][bloxstrap]. It's designed to enhance your Roblox experience with modern UI, advanced customization, and performance optimization tools.
...
- **FPS Unlocker** — Independent toggle that detects your monitor's refresh rate and lifts the frame cap on high-Hz displays (120/144/240Hz)
...
- **Auto-Reconnect After Crash** — Detects Roblox crashes via exit code, and offers a reconnect button to rejoin the exact same server (PlaceId + JobId), with automatic fallback to a new server if the old one is full
